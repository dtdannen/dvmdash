// GENERATED_TITLE: Kind 5204 Service
= Nostr DVM Kind 5204/6204 - Kind 5204 Service
:toc:
:toclevels: 3
...
Kind 5204 appears to be a request to perform some encrypted data processing job. The request includes an encrypted content field, along with some metadata like the requester's public key and signature. The response, kind 6204, contains the encrypted results of the requested job, referencing the ID of the original request.
