// GENERATED_TITLE: Video Conversion
= Nostr DVM Kind 5200/6200 - Video Conversion
:toc:
:toclevels: 3
...
Kind 5200 is a job request to convert a video to another format. The input is a link to a video file or a social media share link. The output is the converted video file, with an optional specified output format.
