// GENERATED_TITLE: Image-to-Video Conversion
= Nostr DVM Kind 5202/6202 - Image-to-Video Conversion
:toc:
:toclevels: 3
...
Kind 5202 is a Data Vending Machine (DVM) job type that converts a static image into a short animated video clip. The input for this kind is a link pointing to an image file. The output is a link to the generated video.
